...
> Este proyecto replica fielmente el comportamiento de una CPU segmentada a nivel de ciclo de reloj. Los conceptos implementados aplican directamente a arquitecturas reales como MIPS, RISC-V y ARM.
